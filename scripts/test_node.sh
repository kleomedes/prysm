...
#
# Examples:
# CHAIN_ID="localchain-1" HOME_DIR="~/.prysm" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="localchain-2" HOME_DIR="~/.prysm" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export BINARY=${BINARY:-prysmd}
export DENOM=${DENOM:-uprysm}
...
from_scratch () {
  ...
  # prysm1efd63aw40lxf3n4mhf7dzhjkr453axur84r68t
  ...
  # prysm1hj5fveer5cjtn4wd6wstzugjfdxzl0xpmps7wz
  ...
  update_test_genesis '.app_state["bank"]["denom_metadata"]=[
        {
            ...
            "description": "Denom metadata for Prysm (uprysm)",
            "display": "PRYSM",
            "name": "PRYSM",
            "symbol": "PRYSM"
        }
